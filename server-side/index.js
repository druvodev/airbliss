...
async function run() {
  try {
    const usersCollection = client.db("airBlissDb").collection("users");
    const flightsCollection = client.db("airBlissDb").collection("flights");
    const bookingsCollection = client.db("airBlissDb").collection("bookings");
