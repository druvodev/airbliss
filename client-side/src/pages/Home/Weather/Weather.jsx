        ...
        <div className="md:w-7/12 x-10 mx-auto p-5 opacity-100  text-white">
          ...
          <div className="flex justify-between sm:justify-around mt-4">
            <div className="space-y-2">
              ...
              <p>
                Wind:{" "}
                <span className="text-lg">WNW {weather?.wind?.speed} mph</span>
              </p>

              <p>
                Sunrise:{" "}
                <span className="text-lg">{moment(sunrise).format("LT")}</span>{" "}
              </p>
              <p>
                Sunset:{" "}
                <span className="text-lg">{moment(sunset).format("LT")}</span>{" "}
              </p>
            </div>
            <div>
              {weather?.weather?.[0]?.main === "Rain" ? (
                <>
                  <img
                    src="https://i.ibb.co/12wFypt/cloudy.png"
                    alt=""
                    className="w-20 h-20"
                  />
                ...
                <>
                  <img
                    src="https://i.ibb.co/qRvHCpd/4102314-cloud-cloudy-sun-sunny-weather-icon.png"
                    alt=""
                    className="w-20 h-20"
                  />
                  <p className="text-center text-xl">
