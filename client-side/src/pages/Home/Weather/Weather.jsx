        ...
        <div className="">
            ...
            {/* <div className="py-6 relative mx-auto xl:px-10 bg-gradient-to-bl to-blue-900 from-cyan-600">
                ...
                <div className="md:w-7/12 x-10 mx-auto p-5 opacity-100  text-white">
                    ...
                    <h4 className="text-center text-3xl">{((weather?.main?.temp) - 273.15).toFixed(1)}&#xB0;<span className="text-xl">c</span></h4>
                    <div className="flex justify-between sm:justify-around mt-4">
                        <div className="space-y-2">
                            <p>Feels Like: <span className="text-lg">{((weather?.main?.feels_like) - 273.15).toFixed(2)}&#xB0; <span className="text-sm">C</span></span></p>
...

                            {
                                weather?.weather?.[0]?.main === "Rain" ?
                                    <>
                                        ...
                                        <p className="text-center text-xl">{weather?.weather?.[0]?.main}</p>
                                    </> :
            ...
            {
                weather?.name ? <><h2 className="text-xl text-center ">{weather?.name}</h2>
                <h4 className="text-center text-2xl">{((weather?.main?.temp) - 273.15).toFixed(1)}&#xB0;<span className="text-base">c</span></h4></> : <></>
            }
        </div>
    );
};
