...
const RecommendedHotelDetails = () => {
    ...
    useEffect(() => {
        fetch("/recommendedFlights.json")
            .then(res => res.json())
            .then(data => {
                const selectedFlight = data.filter(flight => flight.id === parseInt(id))
    ...
    return (
        <div className='pb-16'>
            <div className=''>
                <img src='https://i.ibb.co/99WG5TR/pascal-meier-UYies-SO4-Fi-M-unsplash.jpg' className='w-full h-[450px] object-cover' alt="" />
                <div className='absolute left-4 top-20  sm:left-1/3 sm:top-1/3  md:left-1/4 md:top-1/3  lg:left-1/3 lg:top-1/3 text-white text-center'>
                    <h3 className='text-xl sm:text-3xl md:text-5xl lg:text-7xl font-bold'>AirBliss</h3>
                    <h3 className='text-sm sm:text-lg lg:text-xl font-bold'>The sky is not the limit, it's only the beginning</h3>
                </div>
            </div>
                                    ...
                                    <div>
                                        {
                                            f?.overviews.map((overview, index) =>
                                                <div key={index} className='py-4 px-6 bg-[#f5f5f5] text-sm space-y-2 '>
                                                    ...
                                                    <div className='flex justify-between items-center'>
                                                        <p className='uppercase text-[#01b7f2]'>Cancellation:</p>
                                                        <p className='uppercase'>${overview?.cancel_fee}/Person</p>
                                                    </div>
                                                    <div className='flex justify-between items-center'>
                                   ...
                                   <Amenities></Amenities>
                                    ...
                                    <div className='text-sm uppercase mt-4'>
                                        <div className='p-2 bg-[#f5f5f5] text-sm'>
                                            <h1 className='text-lg font-semibold'>Travel Information</h1>
                                ...
                                <div className='sm:w-8/12 mx-auto md:w-4/12'>
                                    ...
                                    <div className="flex mt-4 gap-x-6 sm:gap-x-2 sm:justify-between items-center lg:px-4">
                                        <div className='flex gap-x-3 items-center'>
                                            ...
                                            <div>
                                                <h3 className="card-title lg:mr-8 lg:text-lg md:text-base text-lg">{f?.destination}</h3>
                                    ...
                                    <div className='mt-10 p-4 shadow-2xl shadow-gray-400 space-y-4'>
                                        ...
                                        <div>
                                            ...
                                            <p className='flex items-center gap-x-2'><FaEnvelope className='text-cyan-400'></FaEnvelope> airbliss@gmail.com</p>
                                        </div>
