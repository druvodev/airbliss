          ...
          {deal.map((d) => (
            <div key={d?.id} className="">
              <div className="mb-10 flex sm:gap-x-5 items-center justify-center">
                <h2 className="text-xl sm:t traveler information formext-3xl md:text-5xl font-bold text-cyan-600">AirBLiss <span>|</span> </h2>
                <img src={d?.offered_by} alt="" className="w-8/12 sm:w-6/12 md:w-1/2 lg:w-1/2 " />
              </div>
              {/* Offer  */}
              <div className="mb-10">
                <div>
                  <h3 className="text-cyan-600 text-3xl font-semibold text-center mb-20">What is the offer</h3>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-x-4 gap-y-12 text-center ">
                  <div className="bg-[#F8F9FA] pt-20 pb-8 px-6 relative">
                    ...
                    <h4 className="text-cyan-600 text-lg font-semibold ">Offer</h4>
                  ...
                  <div className="bg-[#F8F9FA] pt-24 pb-8 px-6 relative">
                    ...
                    <h4 className="text-cyan-600 text-lg font-semibold ">Partner</h4>
                  ...
                  <div className="bg-[#F8F9FA] pt-20 pb-8 px-6 relative">
                    ...
                    <h4 className="text-cyan-600 text-lg font-semibold">Validity</h4>
              ...
              <div className="pt-10 md:pt-20  bg-[#F8F9FA] ">
                <h3 className="text-cyan-600 text-3xl font-semibold text-center mb-12">How to avail the offer</h3>

                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-4 gap-y-5 justify-between px-10">
                  <div>
                    <h4 className="text-lg font-semibold text-cyan-600 mb-4">Search</h4>
                    <ul className="list-disc space-y-1">
                      <li>Select destination, journey date & number of travelers on flight tab</li>
                      <li>Click ‘Search’</li>
                    </ul>
                  </div>

                  <div>
                    <h4 className="text-lg font-semibold text-cyan-600 mb-4">Select</h4>
                    <ul className="list-disc space-y-1">
                  ...
                  <div>
                    <h4 className="text-lg font-semibold text-cyan-600 mb-4">Book</h4>
                    <ul className="list-disc space-y-1">
                  ...
                  <div>
                    <h4 className="text-lg font-semibold text-cyan-600 mb-4">Payment</h4>
                    <ul className="list-disc space-y-1">
                      <li>Provide BIN number of your card (First 6 digits your card)</li>
                      <li>Check discount details and click "Proceed to Payment"</li>
                ...
                <div className="mt-12 text-center">
                  <Link to="/" className="px-8 py-4 border rounded-md bg-cyan-500 hover:bg-cyan-600 font-semibold duration-500 text-white">Book Now</Link>
                </div>
              ...
              <div className="mt-10 md:mt-20">
                <h2 className="text-cyan-600 text-3xl font-semibold mb-6">Terms & Condition</h2>
                <div className="pl-6">
                  {
                    d.terms.map((term, index) => <ul key={index} className="list-disc space-y-3 text-sm"><li>{term}</li> </ul>)
                  }
                </div>
          ...
          <div className="mt-6 sm:mt-10">
           ...
           <div className="collapse collapse-arrow border-b">
              ...
              <div className="collapse-content">
                <p>Up to 15% discount on domestic flight bookings for EBL Visa debit & credit cards.</p>
              </div>
            </div>
            <div className="collapse collapse-arrow border-b">
              <input type="radio" name="my-accordion-2" />
            ...
            <div className="collapse collapse-arrow border-b">
              ...
              <div className="collapse-content">
                <p>There is no specific travel period. Customers can purchase air tickets, book hotels and book bus tickets during the offer period for any available travel date.</p>
              </div>
            </div>
            <div className="collapse collapse-arrow border-b">
              <input type="radio" name="my-accordion-2" />
              ...
              <div className="collapse-content">
                <p>All EBL Visa debit and credit card holders are eligible to avail the offer.</p>
              </div>
            </div>
            <div className="collapse collapse-arrow border-b">
              <input type="radio" name="my-accordion-2" />
              ...
              <div className="collapse-content">
                <p>Applicable for both one way and round way domestic flight bookings.</p>
              </div>
            </div>
           </div>
          </div>
