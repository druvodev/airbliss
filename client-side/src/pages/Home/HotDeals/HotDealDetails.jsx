    ...
    return (
        <div className='lg:pb-16 pt-24 px-5 sm:px-10 max-w-7xl mx-auto h-auto overflow-hidden'>
            ...
            <div className='lg:w-10/12 mx-auto'>
                {
                    deal.map(d => <div key={d?.id} className='p-3 shadow-xl '>
                        <div className='flex sm:gap-4 flex-col sm:flex-row gap-y-3  sm:items-center'>
                            ...
                            <div className='space-y-2'>
                                ...
                                <p className='font-semibold text-lg'> <span className='font-bold'>Discount:</span> {d?.discount}%</p>
                                <p className='font-semibold text-lg'> <span className='font-bold'>Air-Line:</span> {d?.airline}</p>
                            </div>
                        </div>
                    </div>)
                }
