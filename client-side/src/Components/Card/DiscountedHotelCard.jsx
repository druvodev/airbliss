    ...
    return (
        <div>
            ...
            <div className="flex justify-between items-center mt-3 px-3">
                ...
                <Link className="py-3 px-6 border border-cyan-300 rounded-lg font-medium bg-cyan-300 hover:bg-cyan-500 hover:text-white duration-500">${(cost - (cost * discount /100)).toFixed(0)} per night</Link>
                </div>
            </div>
        </div>
    );
