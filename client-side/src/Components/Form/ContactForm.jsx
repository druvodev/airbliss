        ...
        <div className="">
            <form className="space-y-5">
                <input type="text" placeholder="Name" name="name"
                    className="outline-none  border-b pb-[2px] block"
                />
                <input type="email" placeholder="Email" name="email"
                    className="outline-none   border-b pb-[2px] block"
                />
                <textarea name="message" id="message" cols="30" rows="4" placeholder="Message" className="outline-none w-9/12  border-b pb-[2px] block"></textarea>
