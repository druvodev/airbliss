...
const ModalInsurance = ({ insurance, onClose, onSubmit }) => {
  ...
  const premiumType =
    insurance?.insurancePolicy?.requestedClaimInfo?.premiumType;
  ...
  return (
    <>
      <dialog id="my_modal_1" open={true} className="modal">
        <div className="bg-black/20 w-full h-full flex justify-center items-center dark:text-gray-400">
          <div className="modal-box w-10/12 max-w-2xl max-h-[95vh] p-8 md:max-h-[100vh] overflow-y-scroll md:overflow-auto dark:bg-slate-700 ">
            <div className="bg-white dark:bg-slate-700 w-full h-full rounded-lg ">
