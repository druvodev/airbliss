    ...
    return (
        <div>
            <div className="relative w-full h-[400px]">
                ...
                <div className='flex absolute -bottom-28 gap-5 right-[50%]'>
                    <img
                        src={
                            photo
                                ? photo
            ...
            <div className='max-w-5xl grid gap-3 grid-row-2 mx-auto mt-36 mb-24'>
                <div className='grid gap-4 grid-cols-2'>
                    <div className='grid grid-rows-4 gap-3'>
                        ...
                        <div className='flex'>
                            ...
                            <h1 className='text-xl'><span className='font-bold'>Relationship:</span> {occupation}</h1>
                        </div>
                    </div>
                    <div className='grid grid-rows-4 gap-3'>
                        <div className='flex'>
                        ...
                        <div className='flex'>
                            ...
                            <h1 className='text-xl'><span className='font-bold'>From:</span> {occupation}</h1>
                        </div>
                        <div className='flex'>
                            <HiHomeModern className='text-2xl mr-3 mt-1' />
                            <h1 className='text-xl'><span className='font-bold'>Lives in:</span> {occupation}</h1>
                        </div>
                        <div className='flex'>
                            <BiWorld className='text-2xl mr-3 mt-1' />
                            <h1 className='text-xl'><span className='font-bold'>Nationality:</span> {occupation}</h1>
                        </div>
                    </div>
                </div>
                <div className='flex'>
                    <IoInformationCircle className='text-2xl mr-3 mt-1' />
                    <h1 className='text-xl'><span className='font-bold'>About:</span> {occupation}</h1>
                </div>
            </div>
        </div>
    );
